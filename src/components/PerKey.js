...
class PerKey extends React.Component {
  isvisited = false
  font = ['Arial', 'Gisha', 'Aharoni', 'Monospace', 'Cursive', 'Fantasy', 'Levenim MT', 'Gloria Hallelujah']
  ...
  render() {
    return (<div>
      <div class="flex">
        ...
        <button class='key-button item' style={{ fontStyle: 'italic', fontFamily: 'Aldhabi' }} onClick={() => this.click2(this.state.italic)}>I</button>
        <button class='key-button item' style={{ fontWeight: 'bold' }} onClick={() => this.click5(this.state.bold)}>B</button>
